...
app draws its own UI. (A planned `unified_game_services_android_native` provider
will route writes through the Java SDK for native UX; this is the cross-platform
REST tier.)
